...
<head> 
  ...
  <title>Ballot Buzz - Candidates</title>
  <style>
    body {
    ...
    .candidates-row {
      ...
      gap: 2rem;
      flex-wrap: wrap; /* FIXED: makes it responsive */
    }
...
<body>
  <header>
    <div>
      <!-- FIXED: use relative path instead of C: drive -->
    ...
    <div class="candidates-row" id="candidates-row">
      <div class="candidate-card">
        ...
        <div class="candidate-platform">
          Focus on education reform and climate change policies.
        </div>
      </div>
      ...
      <div class="candidate-card">
        ...
        <div class="candidate-platform">
          Advocates for healthcare accessibility and infrastructure development.
        </div>
      </div>
      ...
      <div class="candidate-card">
        ...
        <div class="candidate-platform">
          Promotes economic growth and social welfare programs.
        </div>
      </div>
    </div>
  </main>
  ...
  <script>
    function filterCandidates() {
      ...
      cards.forEach(card => {
        ...
        if (name.includes(input) || platform.includes(input)) {
          card.style.display = '';
        } else {

...
<head> 
  ...
  <title>Ballot Buzz - Voting Guides</title>
  <style>
    body {
    ...
    /* Container with 3 columns side by side */
    .columns {
      display: flex;
      gap: 2rem;
      justify-content: space-between;
    ...
    .column {
      flex: 1 1 30%; /* each column about 30% width */
      display: flex;
      flex-direction: column;
      gap: 1.5rem;
    }
...
<body>
  ...
  <main>
    ...
    <div class="columns">
      <!-- LEFT COLUMN: 2 Video placeholders -->
      ...
      <!-- CENTER COLUMN: 2 Downloadable files -->
  ...
  <footer>
    &copy; 2025 Ballot Buzz. All rights reserved.
  </footer>
</body>
</html>
